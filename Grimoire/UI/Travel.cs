...
namespace Grimoire.UI
{
    public class Travel : DarkForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnUltraDrakath.Location = new System.Drawing.Point(6, 69);
			...
			this.btnTreeTitan.Location = new System.Drawing.Point(6, 44);
			...
			this.btnTowerOfDoom.Location = new System.Drawing.Point(6, 93);
			...
			this.btnNecroDungeon.Location = new System.Drawing.Point(6, 118);
		...
		private async Task SkipMap(string clientPacket, string map)
		{
			await Proxy.Instance.SendToClient(clientPacket);
			await Task.Delay(500);
			string room = chkPriv.Checked ? $"-{numPriv.Value}" : "";
			Player.JoinMap(map + room);
		}
